...
const Signin = ({ setloginEmail, loginEmail }) => {
  ...
  const submitHandle = (e) => {
    e.preventDefault();
    let findData = getDataArray.find((e) => formData.email === e.email && formData.password === e.password);
    if (formData.email === findData?.email && formData.password === findData.password) {
